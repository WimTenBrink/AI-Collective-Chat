...
const ChatInterface: React.FC<ChatInterfaceProps> = ({ messages, bots, onSendMessage, isChatActive, onToggleChat, onOpenSettings, onOpenConsole }) => {
      ...
      <div className="p-4 border-b border-gray-700 flex justify-between items-center">
        ...
        <div className="flex items-center gap-2 w-24 justify-end">
          <button onClick={onToggleChat} title={isChatActive ? "Pause Bot Chat" : "Resume Bot Chat"} className="text-gray-400 hover:text-cyan-400 transition-colors">
           ...
           <button onClick={onOpenConsole} title="Console Log" className="text-gray-400 hover:text-cyan-400 transition-colors">
            <ConsoleIcon />
          </button>
